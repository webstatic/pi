...
function twos_complement1(value, no_of_bits) {
...
function Compass(i2cBusNum, options) {
    ...
    try {
        ...
        //this.i2c.writeByteSync(HMC5883L_ADDRESS, HMC5883L_MODE_REGISTER, 1);
    } catch (ex) {
...
Compass.prototype.getRawValues = function (callback) {
    ...
    var self = this;
    self.i2c.sendByteSync(HMC5883L_ADDRESS, 3)
    try {
 ...
 * @param  {string} axis2 The second axis (determines West)
 */
Compass.prototype.getHeadingDegrees = function (axis1, axis2, target, callback) {
    ...
    this.getHeading(axis1, axis2, function (err, heading) {
        if (err) {
            ...
            callback(null, heading, compassHeading);
        }
    });
};
