...
NwServiceProcess.cmdMethod['getInfo'] = function (data, cb) {
    //console.log('getInfo', infoData);
    // infoData.testData = {

    //     ActionControl: ActionControl,

    //     currentDistance: ActionControl.PositionControl.currentDistance,
    //     currentTarget: ActionControl.PositionControl.currentTarget,
    ...
    if (logdataObj) {
        ...
        if (logdataObj.gps) {
            ...
            if (last_lat) {
                ...
                infoData.gps.gpsHeading = gpsHeading
